      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="relative w-full sm:max-w-sm">
          ...
          <input
            ...
            className="w-full rounded-(--radius-md) border border-(--color-border-subtle) bg-(--color-surface) py-2 pl-9 pr-3 text-sm text-(--color-text-primary) outline-none transition-colors focus:border-(--color-accent)"
          />
        </div>
          ...
          {DIFFICULTY_FILTERS.map((filter) => {
            ...
            return (
              <button
                ...
                className={`rounded-(--radius-sm) px-3 py-1.5 text-sm font-medium transition-colors cursor-pointer ${
                  active
        ...
        <div className="mt-8 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page <= 1}
              className="rounded-(--radius-sm) border border-(--color-border-subtle) px-3 py-1.5 text-sm font-medium text-(--color-text-primary) transition-colors hover:bg-(--color-badge-bg) disabled:cursor-not-allowed disabled:opacity-50"
            >
              Previous
            </button>
            <button
