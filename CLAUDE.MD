# ElevateSDE Development Guidelines 

This file contains critical guidelines that MUST be read and followed by any AI agent working on this repository. Always adhere to these instructions.
